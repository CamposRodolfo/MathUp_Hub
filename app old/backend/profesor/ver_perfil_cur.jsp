...
<body class="body">
    <header>
        <a class="logo" href="../../profesor/home.html"><img src="../../assets/Imagenes/MathUP.png" alt="logo"></a>
    ...
    <div class="navbar">
        <a class="navbar-opcion" href="../../profesor/home.html">Inicio</a>
        <div class="dropdown">
            ...
            <div class="navbar-opcion dropdown-content">
                <a href="../../profesor/lista_cursos.html">Lista de Cursos</a>
                <a href="../../profesor/registro_curso.html">Registro de Cursos</a>
                <a href="../../profesor/registro_leccion.html">Registar Lección</a>
            </div>
        </div>
        <a class="navbar-opcion" href="../../profesor/about.html">Sobre Nosotros</a>
    </div> <!-- Fin Navbar -->
