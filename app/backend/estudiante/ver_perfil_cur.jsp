...
<body class="body">
    <header>
        <a class="logo" href="../../estudiante/home.html"><img src="../../assets/Imagenes/MathUP.png" alt="logo"></a>
    ...
    <div class="navbar">
        <a class="navbar-opcion" href="../../estudiante/home.html">Inicio</a>
        <div class="dropdown">
            ...
            <div class="navbar-opcion dropdown-content">
                <a href="../../estudiante/lista_cursos.html">Lista de Cursos</a>
            </div>
        </div>
        <a class="navbar-opcion" href="../../estudiante/about.html">Sobre Nosotros</a>
    </div> <!-- Fin Navbar -->
