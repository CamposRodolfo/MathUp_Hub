...
--estos procedimientos no estan creados
BEGIN
    insertar_problema('Opcion A', 'Opcion B', 'Opcion C', 'Opcion A', 1);
    insertar_problema('Opcion D', 'Opcion E', 'Opcion F', 'Opcion D', 2);
    insertar_problema('Opcion G', 'Opcion H', 'Opcion I', 'Opcion G', 3);
    insertar_problema('Opcion J', 'Opcion K', 'Opcion L', 'Opcion J', 4);
    insertar_problema('Opcion M', 'Opcion N', 'Opcion O', 'Opcion M', 5);
END;
/
